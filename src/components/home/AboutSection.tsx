...
const sectionContent = {
  intro: {
    ...
    stat1: { value: "79+", label: "Năm đào tạo", icon: Award },
    stat2: { value: "50K+", label: "Sinh viên", icon: Users },
    badge: { title: "ĐH Công nghệ GTVT", subtitle: "Việc làm & Tuyển dụng" },
    cards: [
      {
        icon: Target,
        title: "Sứ mạng",
    ...
    cta: { text: "Tìm hiểu thêm về chúng tôi", subText: "3 cơ sở đào tạo trên toàn quốc" },
  },
  faculties: {
    image: aboutStudents,
  ...
  leaders: {
    ...
    stat1: { value: "100+", label: "Giáo sư, Tiến sĩ", icon: Award },
    stat2: { value: "500+", label: "Giảng viên", icon: Users },
    badge: { title: "Ban Giám hiệu", subtitle: "Lãnh đạo & Định hướng" },
    cards: [
      {
        icon: UserCog,
        title: "Ban Giám hiệu",
  ...
  center: {
    ...
    stat1: { value: "200+", label: "Đối tác DN", icon: Briefcase },
    stat2: { value: "95%", label: "Tỉ lệ việc làm", icon: Network },
    badge: { title: "Trung tâm KNDTN", subtitle: "Hỗ trợ & Kết nối" },
    cards: [
      {
        icon: Handshake,
    ...
    cta: { text: "Liên hệ Trung tâm", subText: "Hỗ trợ sinh viên 24/7" },
  },
};
          ...
          <div className="lg:col-span-7 space-y-5">
            {currentContent.cards.map((card, cardIdx) => {
              ...
              return (
                <div
                  key={cardIdx}
                  className="group relative bg-card/80 backdrop-blur-sm rounded-2xl p-6 border border-border/50 hover:border-primary/40 hover:shadow-xl transition-all duration-500 overflow-hidden"
                >
                  {/* Hover Gradient */}
                  <div
                    className={`absolute inset-0 ${
                      isSecondary ? "bg-gradient-to-r from-secondary/5" : "bg-gradient-to-r from-primary/5"
                  ...
                  <div className="relative flex items-start gap-5">
                    <div
                      className={`w-14 h-14 bg-gradient-to-br ${
                        isSecondary ? "from-secondary to-secondary/80" : "from-primary to-primary/80"
                      } rounded-2xl flex items-center justify-center shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                    >
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-bold text-foreground mb-3 flex items-center gap-2">
                        ...
                        {card.badge && (
                          <span
                            className={`text-xs ${
                              isSecondary ? "bg-secondary/10 text-secondary-foreground" : "bg-primary/10 text-primary"
