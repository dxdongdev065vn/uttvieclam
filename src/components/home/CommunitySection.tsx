  ...
  return <section className="py-16 md:py-20 bg-gradient-to-b from-muted/30 to-background relative overflow-hidden">
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-primary/10 border-primary/20 rounded-full px-4 py-1.5 mb-4 border-8">
            <Users className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium text-primary">Kết Nối Cộng Đồng</span>
          </div>
